...
- **Data Processing Agreement (DPA):** Available on request for GDPR compliance. Contact [hello@namihr.com](mailto:hello@namihr.com).
...
For privacy inquiries, contact [hello@namihr.com](mailto:hello@namihr.com).
