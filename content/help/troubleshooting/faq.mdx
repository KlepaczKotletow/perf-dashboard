...
<Callout type="tip">
Ask your admin to verify your profile exists in Dashboard > Directory. If it does not, they can add you manually or via CSV import.
</Callout>
...
The My Team page is only visible to users with the **manager** role or above (including HR and Admin). If you should be a manager but do not see the page, ask your admin to update your role in Dashboard > Directory.

---

## "How do I change my manager?"

Only admins can update reporting relationships. Ask your admin to go to your profile in Dashboard > Directory and change the manager field.
