...
interface ProfileTabsProps {
  ...
  continuousFeedback: any[];
  directReports: any[];
  skillAverages: { name: string; category: string | null; avg: string; count: number }[];
      ...
      <TabsList className="w-fit">
        ...
        <TabsTrigger value="reviews">
          ...
          {reviewAssignments.length > 0 && (
            <span className="ml-1.5 text-[10px] bg-muted-foreground/10 px-1.5 py-0.5 rounded-full">
      ...
      <TabsContent value="competencies" className="mt-4">
        <Card className="border-border/60">
          ...
          <CardContent>
            {!canSeeAllRatings ? (
              <p className="text-sm text-muted-foreground text-center py-6">
                Competency ratings are only visible to managers and above.
              </p>
      ...
      <TabsContent value="goals" className="mt-4">
        <Card className="border-border/60">
          <CardHeader className="pb-3">
            ...
            <CardDescription>Individual and team objectives</CardDescription>
          </CardHeader>
          <CardContent>
            {goals.length === 0 ? (
              <p className="text-sm text-muted-foreground text-center py-6">
